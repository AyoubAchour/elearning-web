        ...
        <div className="text-center">
          ...
          <div className="mb-6 inline-flex items-center justify-center">
            <div className="rounded-full bg-green-100 p-4">
              <svg
                className={`w-14 h-14 text-green-500 transition-transform duration-700 ${animate ? 'transform scale-100' : 'transform scale-0'}`}
          ...
          {course ? (
            <div className="bg-blue-50 border border-blue-100 rounded-lg p-4 mb-6 mt-4">
              ...
              <div className="bg-white rounded-lg p-4 shadow-sm border border-blue-100">
                ...
                <div className="flex flex-col space-y-2 text-left">
                  <div className="flex justify-between items-center">
                    <span className="font-medium text-gray-700">Course length:</span>
                    <span className="text-gray-900">{course.duration || 'Not specified'}</span>
                  </div>
                  <div className="flex justify-between items-center">

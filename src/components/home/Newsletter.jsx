            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col items-center text-white">
                    ...
                    <div className="text-center mb-12">
                        <h3 className="text-2xl font-medium mb-6">Subscribe to get our Newsletter</h3>
                        <div className="flex max-w-md mx-auto">
                            ...
                            />
                            <button className="px-8 py-3 bg-blue-500 text-white rounded-r-full hover:bg-blue-600 transition-colors">
                                Subscribe
                            </button>
                        </div>
                    </div>

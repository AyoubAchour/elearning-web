...
const InstructorLayout = () => {
  ...
  const sidebarItems = [
    ...
    { name: 'Create Course', path: '/instructor/courses/create', icon: 'plus' },
    { name: 'Students', path: '/instructor/students', icon: 'users' },
    { name: 'Discussions', path: '/instructor/discussions', icon: 'chat' },
    { name: 'Quizzes', path: '/instructor/quizzes', icon: 'quiz' },
    { name: 'Analytics', path: '/instructor/analytics', icon: 'chart' },
    { name: 'Earnings', path: '/instructor/earnings', icon: 'cash' },
    { name: 'Settings', path: '/instructor/settings', icon: 'cog' },
  ];
        ...
        <header className="bg-white h-16 shadow-sm flex items-center justify-between px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center">
              <span className="text-gray-800 mr-2">Instructor</span>
